...
function Player() {
    ...
    return (
        <div className="h-24 bg-gradient-to-b from-black to-green-900 text-white grid grid-cols-3 text-xs
        md:text-base px-2 md:px-8">
           ...
           <div className="flex items-center space-x-3 md:space-x-4 justify-end pr-5">
              <VolumeDownIcon onClick={() => volume > 0 && setVolume(volume - 10)} className="button text-green-500" />
