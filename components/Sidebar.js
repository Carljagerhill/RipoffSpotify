...
function Sidebar() {
    ...
    console.log("you picked this song >>> ", playlistId);
    ...
    return (
        <div className="text-gray-500 p-5 text-sm lg:text-sm border-r border-gray-900 overflow-y-scroll
        scrollbar-hide h-screen sm:max=w-[12rem] lg:max-w-[15rem] hidden md:inline-flex pb-36">
            <div className="space-y-4">
                ...
                <button className="flex items-center space-x-2 hover:text-white"> 
                    <LibraryIcon className="h-5 w-5 text-green-500" />
                    <p>Your Library</p>
                </button>
